# TakeStack standalone iPhone site

Static public site for the standalone TakeStack iPhone app.
...
Run local checks with `python3 script/check_public_site.py`. This repository does not deploy as part of the check. Production status must be verified separately after an authorised deployment.
